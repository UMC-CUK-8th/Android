...
class AlbumLibraryRVAdapter (): RecyclerView.Adapter<AlbumLibraryRVAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): AlbumLibraryRVAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: AlbumLibraryRVAdapter.ViewHolder, position: Int) {
